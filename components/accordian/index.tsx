...
function Accordian({
    ...
    return <div className={`w-[100%] flex flex-col `} >
        ...
        <div className={`px-[30px] ${selectedTab === idx ? 'max-h-[486px] transition-all duration-1000 ease-in opacity-1' : 'opacity-0 transition-all duration-1000 ease-out overflow-hidden max-h-[0px]'}`}>
